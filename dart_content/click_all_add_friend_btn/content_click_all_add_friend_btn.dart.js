...
(function dartProgram() {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              iFrameElem.src = J.getURL$1$x(B.Runtime_Runtime$fromInterop(J.get$runtime$x($.$get$chrome()._chrome))._runtime, "/ng/content/click_all_add_friend_btn/click_all_add_friend_btn.html");
  ...
  F = {HistoryItem: function HistoryItem() {
    ...
    main: function() {
      ...
      new P._BroadcastStream(t2, t1._eval$1("_BroadcastStream<1>")).listen$1(new F.main_closure());
    },
