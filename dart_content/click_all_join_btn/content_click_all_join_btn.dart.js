        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              iFrameElem.src = J.getURL$1$x(B.Runtime_Runtime$fromInterop(J.get$runtime$x($.$get$chrome()._chrome))._runtime, "/ng/content/click_all_join_btn/click_all_join_btn.html");
