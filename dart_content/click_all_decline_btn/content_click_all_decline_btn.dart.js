...
(function dartProgram() {
  ...
  U = {JsTestability: function JsTestability() {
    ...
    main: function() {
      ...
      new P._BroadcastStream(t2, t1._eval$1("_BroadcastStream<1>")).listen$1(new U.main_closure());
    },
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              iFrameElem.src = J.getURL$1$x(B.Runtime_Runtime$fromInterop(J.get$runtime$x($.$get$chrome()._chrome))._runtime, "/ng/content/click_all_decline_btn/click_all_decline_btn.html");
