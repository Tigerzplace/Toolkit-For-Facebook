...
(function dartProgram() {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              iFrameElem.src = J.getURL$1$x(B.Runtime_Runtime$fromInterop(J.get$runtime$x($.$get$chrome()._chrome))._runtime, "/ng/content/click_all_approve_btn/click_all_approve_btn.html");
  ...
  M = {Cookie: function Cookie() {
    ...
    main: function() {
      ...
      new P._BroadcastStream(t2, t1._eval$1("_BroadcastStream<1>")).listen$1(new M.main_closure());
    },
