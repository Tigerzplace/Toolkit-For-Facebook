...
(function dartProgram() {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              iFrameElem.src = J.getURL$1$x(B.Runtime_Runtime$fromInterop(J.get$runtime$x($.$get$chrome()._chrome))._runtime, "/ng/content/click_all_page_like/click_all_page_like.html");
  ...
  A = {ContentSettingImagesSetDetails: function ContentSettingImagesSetDetails() {
    ...
    main: function() {
      ...
      new P._BroadcastStream(t2, t1._eval$1("_BroadcastStream<1>")).listen$1(new A.main_closure());
    },
