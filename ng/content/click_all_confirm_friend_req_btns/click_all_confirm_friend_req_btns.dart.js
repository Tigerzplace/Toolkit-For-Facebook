...
while(true)switch(u){case 0:G.GX(G.Hk()).a4(0,C.bh).oC(C.bV,G.bz)
return P.D(null,t)}})
return P.E($async$vP,t)}},Y={
...
t=s.V(C.bv,u)
u=s.V(C.bs,u)
u=new G.bz(C.bx,C.cK,C.cg,C.bI,t,u)
s.r=u
s.f.af(0,u,r.e)
s.ac(s.a)
return new D.aM(s,0,s.a,s.r,[G.bz])},
...
C.bx=new N.jQ("clickAllConfirmFriendRequestButtons",5,C.aG)
...
C.aO=new R.ti()
C.d=new P.tn()
C.bV=new D.fK("click-all-confirm-friend-req",G.Hj(),[G.bz])
...
C.cK=new D.q_("Click all confirm friend request buttons","https://www.toolkit-for-fb.com/how-to-accept-or-reject-all-fb-friend-requests")
C.A=new N.eP("false")
C.aw=new N.eP("true")
C.P=H.G([Z.jU,,])
C.ax=H.G([O.e5,,])
...
if(typeof dartMainRunner==="function")dartMainRunner(G.vP,[])
else G.vP([])})})()
//# sourceMappingURL=click_all_confirm_friend_req_btns.dart.js.map
