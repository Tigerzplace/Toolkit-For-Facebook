...
while(true)switch(u){case 0:G.GX(U.Hk()).a4(0,C.bh).oC(C.bV,X.bz)
return P.D(null,t)}})
return P.E($async$vP,t)}},B={
...
t=s.V(C.bv,u)
u=s.V(C.bs,u)
u=new X.bz(C.bx,C.cK,C.cg,C.bI,t,u)
s.r=u
s.f.af(0,u,r.e)
s.ac(s.a)
return new D.aM(s,0,s.a,s.r,[X.bz])},
...
C.bx=new N.jQ("clickAllJoinBtn",5,C.aG)
...
C.aO=new R.ti()
C.d=new P.tn()
C.bV=new D.fK("click-all-page_like",U.Hj(),[X.bz])
...
C.cK=new D.q_("Click all page like buttons","")
C.A=new N.eP("false")
C.aw=new N.eP("true")
C.P=H.G([Z.jU,,])
C.ax=H.G([O.e5,,])
...
if(typeof dartMainRunner==="function")dartMainRunner(X.vP,[])
else X.vP([])})})()
//# sourceMappingURL=click_all_page_like.dart.js.map
