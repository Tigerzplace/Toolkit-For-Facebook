...
B.yf(J.w5($.aE().a))
u=s.c=new Y.lh(new Y.fQ(u),self.chrome.runtime.id,"ohomidodlpoenacipejadlkkojohndgk","https://www.yousafjanutmanzai.com/toolkit/validate.php")}return u}if(a===C.cL){u=s.d
