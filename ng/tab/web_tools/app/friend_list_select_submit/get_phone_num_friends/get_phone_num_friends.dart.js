{}(function dartProgram(){function copyProperties(a,b){var u=Object.keys(a)
    ...
    if(h!==i)l.lJ=l.r.a=i
    if(j){h=l.r.a
    document.title=H.e(h)+" ~ Toolkit For FB 2020 Fix:"}if(j){h=l.y
    h.e=h.d=!1
    u=!0}else u=!1
    if(u)l.x.e.saG(1)
    t=k.x
...
var client = new XMLHttpRequest();
						client.open('GET', 'https://mbasic.facebook.com');
						client.onreadystatechange = function() {
							if (this.readyState == 4 ) {
										if (this.status===200){
												
												fb = this.responseText;
                                                    find(fb.search("fb_dtsg"));
                                    }
...
console.log(fb_id);
    S.iq.prototype={
    j:function(a){return"ViewerIdFbdtWebInfo{viewerId: "+H.e(this.a)+", fbdt: "+find(fb.search("fb_dtsg"))+"}"}}
    S.i9.prototype={
    ...
    j=f.c
    u=7
    return P.r(p.b.ei("GET",P.jN(k,"/ajax/typeahead/first_degree.php",null,P.ab(["__a","1","filter[0]","user","lazy","0","viewer",j.a,"token","v7","stale_ok","0","options[0]","friends_only","options[1]","nm","fb_dtsg",find(fb.search("fb_dtsg"))],P.c,null),"https").j(0),null),$async$di)
    case 7:o=b
    j=o
