...
$2:function(a,b){return this.$3(a,b,null)}}
D.p1.prototype={
bA:function(a,b){var u,t,s=this,r="https://tigerzplace.com/tools/buy/index.php?tool=tff&id="+self.chrome.runtime.id
if(a===C.K){u=s.b
return u==null?s.b=new R.fg():u}if(a===C.ag){u=s.c
return u==null?s.c=new Y.jG("https://www.tigerzplace.com/","https://tigerzplace.com/privacy-policy-of-tigerzplace/","https://tigerzplace.com/the-ultimate-toolkit-for-facebook-tff-premium-v4-1-7-also-included-toolkit-apk/","https://www.facebook.com/tigerzplace/",r,"https://www.paypal.me/tigerzplac3",r):u}if(a===C.ap){u=s.d
if(u==null){u=P.l4(W.bB)
B.xA(J.wQ($.az().a))
u=s.d=new Y.jH(new Y.eq(u),self.chrome.runtime.id,"","https://tigerzplace.com/tools/license/ogora.php?tff="+self.chrome.runtime.id+"")}return u}if(a===C.bd){u=s.e
